        ...
        <div className="flex flex-wrap items-center">
            ...
            <div className="flex flex-1 md:w-1/3 justify-center md:justify-start text-white px-2">
                <span className="relative w-full">
                    <input onKeyUp={searchFunction} aria-label="search" type="search" id="search" placeholder="Search" className="w-full bg-gray-900 text-white transition border border-transparent focus:outline-none focus:border-gray-400 rounded py-3 px-2 pl-10 appearance-none leading-normal"/>
            ...
            <div className="flex w-full pt-2 content-center justify-between md:w-1/3 md:justify-end">
                <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
                    ...
                    <li className="flex-1 md:flex-none md:mr-3">
                        <a href="DashboardPage" className="inline-block py-2 px-4 text-white no-underline">Dashboard</a>
                    </li>
                    
                    <li className="flex-1 md:flex-none md:mr-3">
                        <a href="CalculatorPage" className="inline-block text-white no-underline">Calculator</a>
                    </li>
                    <li className="flex-1 md:flex-none md:mr-3">
